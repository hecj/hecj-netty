 ...
 * @version 1.0
 */
public class ScrcpyDecodeFrame {
...
//            }
            ...
            while(true){
                ...
                if(availableLength < loadLength){
                    inputStream.read(bufferData,nextBufferOffset,availableLength);
                    // 数据长度
                    bufferTotal += availableLength;
                    // 下一次数据加载位置
                    nextBufferOffset += availableLength;
                } else{
